...
export function appendProjects(parentElement) {
  const projectList = [
    ...
    new Project(
      ...
      ckylogs,
      "blogging website",
      "https://ckylogs.pages.dev",
      "https://github.com/ckyever/ckylogs",
    ),
    new Project(
      ...
      "https://dropshop-inventory-app-production.up.railway.app",
    ...
    new Project(
      "Clubhaus",
      "Message board with account creation",
      clubhaus,
      "message board website",
      "https://clubhaus-production-3f52.up.railway.app",
    ...
    new Project(
      ...
      thegroupchat,
      "messaging website",
      "https://thegroupchat-production.up.railway.app",
